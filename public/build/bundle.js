...
var app = (function () {
    ...
    /* src/lib/Counter.svelte generated by Svelte v3.49.0 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t0 = text("count is ");
    			t1 = text(/*count*/ ctx[0]);
    			add_location(button, file$1, 6, 0, 89);
    		},
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t3 = text("Check out ");
    			a = element("a");
    			a.textContent = "SvelteKit";
    			t5 = text(", the official Svelte\n        app framework powered by Vite!");
    			add_location(h1, file, 4, 4, 84);
    			attr_dev(div, "class", "card");
    			add_location(div, file, 6, 4, 107);
    			attr_dev(a, "href", "https://github.com/sveltejs/kit#readme");
    			attr_dev(a, "target", "_blank");
    			add_location(a, file, 11, 18, 184);
    			add_location(p, file, 10, 4, 162);
    			add_location(main, file, 3, 0, 73);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
