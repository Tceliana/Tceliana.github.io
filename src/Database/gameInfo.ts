...
const Games: GameInfo[] =
    ...
    Get the victory, fight the hordes and advance all levels to the end.`,
        ...
        {
            title: "Free Fall",
            description: `You will have to demonstrate your dodging skills, where the ball will have to dodge the walls until it reaches the goal. You can cross on the sides, or under them, all to your imagination.<br/>
